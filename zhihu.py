...
class Question:
    ...
    def to_txt(self):
        filetitle = self.get_title()
        answer_number = self.get_answers_num()
        question_detail = self.get_detail()
        follower_number = self.get_followers_num()
    ...
    def getPeoples(self):
        if self.search_type != 'people':
            ...
            for people in people_list:
                people_url = "http://www.zhihu.com"+people["href"]
